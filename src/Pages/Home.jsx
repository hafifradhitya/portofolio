...
const WORDS = ["Informatics Engineering Student", "Software Engineering"];
const TECH_STACK = ["Laravel", "PHP", "Node.js", "Javascript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/hafifradhitya" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/radhitya-hafif/" },
  { icon: Instagram, link: "https://www.instagram.com/hafif_radhitya?igsh=cWtkOGN6enRwM2hm" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Membangun Sistem di Balik Layar yang Cepat, Aman, dan Handal untuk Mendukung Solusi Digital.
                </p>
